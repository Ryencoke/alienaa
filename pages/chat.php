...
$rows = array_reverse($pdo->query(
  'SELECT c.body, c.created_at, p.username, p.role, p.chat_color
  ...
  <div id="chatroom" class="chatroom">
    <?php if ($rows): foreach ($rows as $r): $col = chat_color($r['role'], $r['chat_color']); ?>
      <div class="chatline">
        ...
        <b style="color:<?= e($col) ?>"><?= e($r['username']) ?>:</b>
...
(function(){
  ...
  function render(msgs){
    ...
    msgs.forEach(function(m){
      ...
      var who=document.createElement('b'); who.textContent=' '+m.username+': '; who.style.color=m.color;
